#!/usr/bin/env python3
"""Phase 6.4.9k — Voluntary Switch Scoring Smoke.

Scoring ON. Measures whether scoring affects selection quality.

Arms:
  A: vs DoublesBasicAwarePlayer — configurable (default 20)
  B: vs DoublesSafeRandomPlayer — configurable (default 20)
  C: vs DoublesDamageAwarePlayer — configurable (default 20)
...
def build_argument_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--battles-a", type=int, default=20)
    p.add_argument("--battles-b", type=int, default=20)
    p.add_argument("--battles-c", type=int, default=20)
    return p
